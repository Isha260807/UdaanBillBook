    ...
    <div className="font-sans bg-slate-50/50 rounded-xl overflow-hidden border border-slate-200 text-slate-800 text-[10px] leading-snug shadow-sm flex flex-col">
      ...
      <div className={`p-4 text-white ${activeColor.bgClass} flex flex-col sm:flex-row justify-between items-center gap-3 relative overflow-hidden`}>
        ...
        <div className="text-center sm:text-right space-y-0.5 font-mono text-[9px]">
          <p className="text-[10px] font-bold tracking-widest uppercase bg-white/20 px-2.5 py-0.5 rounded-full inline-block">TAX INVOICE</p>
            ...
            <thead className={`${activeColor.bgClass} text-white text-[8px] uppercase font-bold`}>
              <tr className="divide-x divide-white/10">
                {activeColsInOrder.map((key) => {
                  ...
                  if (key === "itemName") return <th key={key} className="p-1.5 min-w-[70px]">{colNames.itemName || "Description"}</th>;
                  if (key === "itemCode") return <th key={key} className="p-1.5 text-center w-14">{colNames.itemCode || "Item Code"}</th>;
                  if (key === "hsnSac") return <th key={key} className="p-1.5 text-center w-16">{colNames.hsnSac || "HSN/SAC"}</th>;
                  if (key === "batchNo") return <th key={key} className="p-1.5 text-center w-14">{colNames.batchNo || "Batch No."}</th>;
                  if (key === "expDate") return <th key={key} className="p-1.5 text-center w-14">{colNames.expDate || "Exp. Date"}</th>;
                  if (key === "mfgDate") return <th key={key} className="p-1.5 text-center w-14">{colNames.mfgDate || "Mfg. Date"}</th>;
                  if (key === "mrp") return <th key={key} className="p-1.5 text-right w-14">{colNames.mrp || "MRP"}</th>;
                  if (key === "size") return <th key={key} className="p-1.5 text-center w-10">{colNames.size || "Size"}</th>;
                  if (key === "modelNo") return <th key={key} className="p-1.5 text-center w-14">{colNames.modelNo || "Model No."}</th>;
                  if (key === "description") return <th key={key} className="p-1.5 min-w-[70px]">{colNames.description || "Desc"}</th>;
                  if (key === "count") return <th key={key} className="p-1.5 text-center w-10">{colNames.count || "Count"}</th>;
                  if (key === "colour") return <th key={key} className="p-1.5 text-center w-12">{colNames.colour || "Colour"}</th>;
                  if (key === "material") return <th key={key} className="p-1.5 text-center w-14">{colNames.material || "Material"}</th>;
                  if (key === "brand") return <th key={key} className="p-1.5 text-center w-14">{colNames.brand || "Brand"}</th>;
                  if (key === "serialNo") return <th key={key} className="p-1.5 text-center w-16">{colNames.serialNo || "Serial No."}</th>;
                  if (key === "challanNo") return <th key={key} className="p-1.5 text-center w-16">{colNames.challanNo || "Challan No."}</th>;
                  ...
                  if (key === "discount") return <th key={key} className="p-1.5 text-right w-14">{colNames.discount || "Discount"}</th>;
                  if (key === "discountPercent") return <th key={key} className="p-1.5 text-right w-14">{colNames.discountPercent || "Disc. %"}</th>;
                  if (key === "taxablePriceUnit") return <th key={key} className="p-1.5 text-right w-16">{colNames.taxablePriceUnit || "Taxable"}</th>;
                  if (key === "taxableValue") return <th key={key} className="p-1.5 text-right w-20">Taxable Amt</th>;
                  if (key === "cgst") return <th key={key} className="p-1.5 text-center w-20" colSpan="2">CGST</th>;
                  if (key === "sgst") return <th key={key} className="p-1.5 text-center w-20" colSpan="2">SGST</th>;
              ...
              {lines.map((l, idx) => {
                ...
                return (
                  <tr key={idx} className="hover:bg-slate-50/50">
                    {activeColsInOrder.map((key) => {
                      if (key === "slNo") return <td key={key} className="p-1 text-center">{idx + 1}</td>;
                      if (key === "itemName") return <td key={key} className="p-1 font-bold text-slate-900">{l.name || "Product Name"}</td>;
                      if (key === "itemCode") return <td key={key} className="p-1 text-center">{l.itemCode || "-"}</td>;
                      if (key === "hsnSac") return <td key={key} className="p-1 text-center font-mono">{l.hsnSac || "-"}</td>;
                      if (key === "batchNo") return <td key={key} className="p-1 text-center">{l.batchNo || "-"}</td>;
                      if (key === "expDate") return <td key={key} className="p-1 text-center">{l.expDate || "-"}</td>;
                      if (key === "mfgDate") return <td key={key} className="p-1 text-center">{l.mfgDate || "-"}</td>;
                      if (key === "mrp") return <td key={key} className="p-1 text-right font-mono">{l.mrp ? formatAmt(l.mrp, printSet) : "-"}</td>;
                      if (key === "size") return <td key={key} className="p-1 text-center">{l.size || "-"}</td>;
                      if (key === "modelNo") return <td key={key} className="p-1 text-center">{l.modelNo || "-"}</td>;
                      if (key === "description") return <td key={key} className="p-1 text-left">{l.description || "-"}</td>;
                      if (key === "count") return <td key={key} className="p-1 text-center">{l.count || "-"}</td>;
                      if (key === "colour") return <td key={key} className="p-1 text-center">{l.colour || "-"}</td>;
                      if (key === "material") return <td key={key} className="p-1 text-center">{l.material || "-"}</td>;
                      if (key === "brand") return <td key={key} className="p-1 text-center">{l.brand || "-"}</td>;
                      if (key === "serialNo") return <td key={key} className="p-1 text-center">{l.serialNo || "-"}</td>;
                      if (key === "challanNo") return <td key={key} className="p-1 text-center">{l.challanNo || "-"}</td>;
                      if (key === "quantity") return <td key={key} className="p-1 text-center font-mono">{q}</td>;
                      if (key === "unit") return <td key={key} className="p-1 text-center">{l.unit || "Pcs"}</td>;
                      if (key === "priceUnit") return <td key={key} className="p-1 text-right font-mono">{formatAmt(r, printSet)}</td>;
                      if (key === "discount") return <td key={key} className="p-1 text-right font-mono">{formatAmt(dAmount, printSet)}</td>;
                      if (key === "discountPercent") return <td key={key} className="p-1 text-right font-mono">{d}%</td>;
                      if (key === "taxablePriceUnit") return <td key={key} className="p-1 text-right font-mono">{formatAmt(rateAfterDisc / (1 + g/100), printSet)}</td>;
                      if (key === "taxableValue") return <td key={key} className="p-1 text-right font-mono">{formatAmt(taxableVal, printSet)}</td>;
                      if (key === "cgst") return (
                        <React.Fragment key={key}>
                          <td className="p-1 text-center font-mono text-slate-400">{(g / 2)}%</td>
                          <td className="p-1 text-right font-mono">{formatAmt(cgstAmount, printSet)}</td>
                        </React.Fragment>
                      );
                      if (key === "sgst") return (
                        <React.Fragment key={key}>
                      ...
                      if (key === "amount") return <td key={key} className="p-1 text-right font-extrabold font-mono text-slate-900">{formatAmt(lineTotal, printSet)}</td>;
                      return null;
                    })}
                  </tr>
                );
