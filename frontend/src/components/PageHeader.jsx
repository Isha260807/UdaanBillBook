export function PageHeader({
  ...
  return (
    <div className={`flex flex-row items-center justify-between gap-2 sm:gap-3 sm:items-end ${hasHeading ? "mb-3 sm:mb-6" : "mb-3.5 sm:mb-6"} w-full`}>
      {hasHeading && (
      ...
      {actions && <div className="w-full sm:w-auto shrink-0 flex items-center gap-2">{actions}</div>}
    </div>
  );
}
